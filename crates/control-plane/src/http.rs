...
/// instead of slicing the `str` -- this router is #605's already-established test-only,
/// unused-in-production one, but fixed anyway rather than leaving a second landmine here.
